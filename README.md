...
- **Tool calls** — shell commands, `apply_patch`, `spawn_agent`, MCP tools and web searches, each with its input, output and error status, named `server.tool` for MCP and flagged as errors when they fail.
